...
function getRequest1() {
    ...
    // TODO: filtered search qui marche avec la pagination
    // let queryParam = document.querySelector("#queryParam").value;
    // if (queryParam) {
    //     url+= "?" + queryParam;
    // }
...
function getRequest5(clicked) {
    ...
    if(clicked == "previous") {
        if (pageCount > 1) {
            ...
            document.querySelector("#" + clicked).setAttribute("disabled", "");
        }
    } else if (clicked == "next") {
        pageCount++;
    }

    let url = "/api/restaurants?page=" + pageCount;
    ...
    "data": [
        {
            ...
            "grades": [{
                ...
                "grade": "A",
                "score": 8
            }, {"date": "2014-01-15T00:00:00.000Z", "grade": "A", "score": 9}, {
            ...
            "grades": [{
                ...
                "grade": "A",
                "score": 10
            }, {"date": "2014-01-16T00:00:00.000Z", "grade": "B", "score": 23}, {
                "date": "2013-08-07T00:00:00.000Z",
                "grade": "A",
                "score": 10
            }, {"date": "2013-02-21T00:00:00.000Z", "grade": "B", "score": 27}, {
                "date": "2012-06-20T00:00:00.000Z",
                "grade": "B",
                "score": 27
            }, {"date": "2012-01-31T00:00:00.000Z", "grade": "B", "score": 18}],
            "name": "Hot Bagels",
            "restaurant_id": "40363565"
        }, {
            "_id": "56b9f89be0adc7f00f348d06",
            "address": {
                "building": "195",
